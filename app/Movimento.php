...
class Movimento extends Model
{
    ...
    protected $fillable = [
        ...
        'num_licenca_piloto', 'tipo_licenca_piloto', 'instrutor_id', 'validade_licenca_piloto', 'num_certificado_piloto',
        'validade_certificado_piloto', 'classe_certificado_piloto', 'confirmado'
    ];
